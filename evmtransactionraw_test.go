...
func TestEvmTransactionRawScanWithOptionalParams(t *testing.T) {
	...
	_, err := client.Evm.TransactionRaw.Scan(context.TODO(), blockaidclientgo.EvmTransactionRawScanParams{
		...
		Metadata: blockaidclientgo.F[blockaidclientgo.EvmTransactionRawScanParamsMetadataUnion](blockaidclientgo.EvmTransactionRawScanParamsMetadataRoutersEvmModelsMetadataNonDapp{
			Account: blockaidclientgo.F(blockaidclientgo.EvmTransactionRawScanParamsMetadataRoutersEvmModelsMetadataNonDappAccount{
			...
			Connection: blockaidclientgo.F(blockaidclientgo.EvmTransactionRawScanParamsMetadataRoutersEvmModelsMetadataNonDappConnection{
				IPAddress: blockaidclientgo.F("ip_address"),
				UserAgent: blockaidclientgo.F("user_agent"),
			}),
			NonDapp: blockaidclientgo.F(blockaidclientgo.EvmTransactionRawScanParamsMetadataRoutersEvmModelsMetadataNonDappNonDappTrue),
		}),
