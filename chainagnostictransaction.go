...
type ChainAgnosticTransactionScanParamsData struct {
	...
	TransactionAction param.Field[ChainAgnosticTransactionScanParamsDataTransactionAction] `json:"transaction_action"`
}
...
// Action the transaction is making
type ChainAgnosticTransactionScanParamsDataTransactionAction string

const (
	ChainAgnosticTransactionScanParamsDataTransactionActionDeposit    ChainAgnosticTransactionScanParamsDataTransactionAction = "deposit"
	ChainAgnosticTransactionScanParamsDataTransactionActionWithdrawal ChainAgnosticTransactionScanParamsDataTransactionAction = "withdrawal"
)

func (r ChainAgnosticTransactionScanParamsDataTransactionAction) IsKnown() bool {
	switch r {
	case ChainAgnosticTransactionScanParamsDataTransactionActionDeposit, ChainAgnosticTransactionScanParamsDataTransactionActionWithdrawal:
		return true
	}
	return false
}
