...
func TestEvmJsonRpcScanWithOptionalParams(t *testing.T) {
	...
	_, err := client.Evm.JsonRpc.Scan(context.TODO(), blockaidclientgo.EvmJsonRpcScanParams{
		Chain: blockaidclientgo.F[blockaidclientgo.EvmJsonRpcScanParamsChainUnion](blockaidclientgo.TransactionScanSupportedChain(blockaidclientgo.TransactionScanSupportedChainEthereum)),
