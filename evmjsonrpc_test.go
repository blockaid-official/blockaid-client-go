...
func TestEvmJsonRpcScanWithOptionalParams(t *testing.T) {
	...
	_, err := client.Evm.JsonRpc.Scan(context.TODO(), blockaidclientgo.EvmJsonRpcScanParams{
		...
		Metadata: blockaidclientgo.F[blockaidclientgo.EvmJsonRpcScanParamsMetadataUnion](blockaidclientgo.EvmJsonRpcScanParamsMetadataRoutersEvmModelsMetadataNonDapp{
			Account: blockaidclientgo.F(blockaidclientgo.EvmJsonRpcScanParamsMetadataRoutersEvmModelsMetadataNonDappAccount{
			...
			Connection: blockaidclientgo.F(blockaidclientgo.EvmJsonRpcScanParamsMetadataRoutersEvmModelsMetadataNonDappConnection{
