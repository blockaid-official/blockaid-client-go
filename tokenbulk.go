...
const (
	...
	TokenBulkScanResponseResultsFeaturesFeatureIDKnownRugpullCodePattern        TokenBulkScanResponseResultsFeaturesFeatureID = "KNOWN_RUGPULL_CODE_PATTERN"
