...
type SuiTransactionScanRequestParam struct {
	AccountAddress param.Field[string]                         `json:"account_address,required"`
	Chain          param.Field[SuiTransactionScanRequestChain] `json:"chain,required"`
	// Metadata
	Metadata    param.Field[SuiTransactionScanRequestMetadataUnionParam] `json:"metadata,required"`
	...
	Options param.Field[[]SuiTransactionScanRequestOption] `json:"options"`
}

func (r SuiTransactionScanRequestParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

type SuiTransactionScanRequestChain string

const (
	SuiTransactionScanRequestChainMainnet SuiTransactionScanRequestChain = "mainnet"
	SuiTransactionScanRequestChainTestnet SuiTransactionScanRequestChain = "testnet"
	SuiTransactionScanRequestChainDevnet  SuiTransactionScanRequestChain = "devnet"
)

func (r SuiTransactionScanRequestChain) IsKnown() bool {
	switch r {
	case SuiTransactionScanRequestChainMainnet, SuiTransactionScanRequestChainTestnet, SuiTransactionScanRequestChainDevnet:
		return true
	}
	return false
}
...
// Metadata
type SuiTransactionScanRequestMetadataParam struct {
	// Metadata for wallet requests
	Type param.Field[SuiTransactionScanRequestMetadataType] `json:"type"`
	// URL of the dApp originating the transaction
	URL param.Field[string] `json:"url"`
}

func (r SuiTransactionScanRequestMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r SuiTransactionScanRequestMetadataParam) implementsSuiTransactionScanRequestMetadataUnionParam() {
}

// Metadata
//
// Satisfied by [SuiTransactionScanRequestMetadataSuiWalletRequestMetadataParam],
// [SuiTransactionScanRequestMetadataSuiInAppRequestMetadataParam],
// [SuiTransactionScanRequestMetadataParam].
type SuiTransactionScanRequestMetadataUnionParam interface {
	implementsSuiTransactionScanRequestMetadataUnionParam()
}

type SuiTransactionScanRequestMetadataSuiWalletRequestMetadataParam struct {
	// Metadata for wallet requests
	Type param.Field[SuiTransactionScanRequestMetadataSuiWalletRequestMetadataType] `json:"type,required"`
	// URL of the dApp originating the transaction
	URL param.Field[string] `json:"url,required"`
}

func (r SuiTransactionScanRequestMetadataSuiWalletRequestMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r SuiTransactionScanRequestMetadataSuiWalletRequestMetadataParam) implementsSuiTransactionScanRequestMetadataUnionParam() {
}

// Metadata for wallet requests
type SuiTransactionScanRequestMetadataSuiWalletRequestMetadataType string

const (
	SuiTransactionScanRequestMetadataSuiWalletRequestMetadataTypeWallet SuiTransactionScanRequestMetadataSuiWalletRequestMetadataType = "wallet"
)

func (r SuiTransactionScanRequestMetadataSuiWalletRequestMetadataType) IsKnown() bool {
	switch r {
	case SuiTransactionScanRequestMetadataSuiWalletRequestMetadataTypeWallet:
		return true
	}
	return false
}

type SuiTransactionScanRequestMetadataSuiInAppRequestMetadataParam struct {
	// Metadata for in-app requests
	Type param.Field[SuiTransactionScanRequestMetadataSuiInAppRequestMetadataType] `json:"type"`
}

func (r SuiTransactionScanRequestMetadataSuiInAppRequestMetadataParam) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

func (r SuiTransactionScanRequestMetadataSuiInAppRequestMetadataParam) implementsSuiTransactionScanRequestMetadataUnionParam() {
}

// Metadata for in-app requests
type SuiTransactionScanRequestMetadataSuiInAppRequestMetadataType string

const (
	SuiTransactionScanRequestMetadataSuiInAppRequestMetadataTypeInApp SuiTransactionScanRequestMetadataSuiInAppRequestMetadataType = "in_app"
)

func (r SuiTransactionScanRequestMetadataSuiInAppRequestMetadataType) IsKnown() bool {
	switch r {
	case SuiTransactionScanRequestMetadataSuiInAppRequestMetadataTypeInApp:
		return true
	}
	return false
}
...
// Metadata for wallet requests
type SuiTransactionScanRequestMetadataType string

const (
	SuiTransactionScanRequestMetadataTypeWallet SuiTransactionScanRequestMetadataType = "wallet"
	SuiTransactionScanRequestMetadataTypeInApp  SuiTransactionScanRequestMetadataType = "in_app"
)

func (r SuiTransactionScanRequestMetadataType) IsKnown() bool {
	switch r {
	case SuiTransactionScanRequestMetadataTypeWallet, SuiTransactionScanRequestMetadataTypeInApp:
		return true
	}
	return false
}

type SuiTransactionScanRequestOption string

const (
	SuiTransactionScanRequestOptionValidation SuiTransactionScanRequestOption = "validation"
	SuiTransactionScanRequestOptionSimulation SuiTransactionScanRequestOption = "simulation"
)

func (r SuiTransactionScanRequestOption) IsKnown() bool {
	switch r {
	case SuiTransactionScanRequestOptionValidation, SuiTransactionScanRequestOptionSimulation:
		return true
	}
	return false
}
...
type SuiTransactionScanResponseSimulation struct {
	...
	// This field can have the runtime type of
	// [[]SuiTransactionScanResponseSimulationSuiSimulationResultAddressDetail].
...
// suiTransactionScanResponseSimulationSuiSimulationResultAddressDetailJSON
// contains the JSON metadata for the struct
// [SuiTransactionScanResponseSimulationSuiSimulationResultAddressDetail]
type suiTransactionScanResponseSimulationSuiSimulationResultAddressDetailJSON struct {
...
func (r *SuiTransactionScanResponseSimulationSuiSimulationResultAddressDetail) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r suiTransactionScanResponseSimulationSuiSimulationResultAddressDetailJSON) RawJSON() string {
	return r.raw
}
