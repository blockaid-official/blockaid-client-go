...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("BLOCKAID_CUSTOM_HEADERS"); ok {
...
// environment (BLOCKAID_CLIENT_API_KEY, BLOCKAID_CLIENT_ID_KEY,
// BLOCKAID_BASE_URL). The option passed in as arguments are applied after these
...
func NewClient(opts ...option.RequestOption) (r *Client) {
	...
	r.Hedera = NewHederaService(opts...)
