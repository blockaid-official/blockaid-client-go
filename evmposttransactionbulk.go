...
type EvmPostTransactionBulkScanParams struct {
	...
	Metadata param.Field[EvmPostTransactionBulkScanParamsMetadata] `json:"metadata" api:"required"`
...
type EvmPostTransactionBulkScanParamsMetadata struct {
	...
	// account_addresses).
	Account param.Field[EvmPostTransactionBulkScanParamsMetadataAccount] `json:"account"`
	// Connection metadata including user agent, IP information, and origin.
	Connection param.Field[EvmPostTransactionBulkScanParamsMetadataConnection] `json:"connection"`
...
// End-user account context (id, age, country, creation time, and
// account_addresses).
type EvmPostTransactionBulkScanParamsMetadataAccount struct {
...
func (r EvmPostTransactionBulkScanParamsMetadataAccount) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// Connection metadata including user agent, IP information, and origin.
type EvmPostTransactionBulkScanParamsMetadataConnection struct {
...
func (r EvmPostTransactionBulkScanParamsMetadataConnection) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
