...
const (
	...
	TokenScanResponseFeaturesFeatureIDKnownRugpullCodePattern        TokenScanResponseFeaturesFeatureID = "KNOWN_RUGPULL_CODE_PATTERN"
	...
	TokenScanResponseFeaturesFeatureIDImpersonatorSensitiveAsset     TokenScanResponseFeaturesFeatureID = "IMPERSONATOR_SENSITIVE_ASSET"
	TokenScanResponseFeaturesFeatureIDImpersonatorHighConfidence     TokenScanResponseFeaturesFeatureID = "IMPERSONATOR_HIGH_CONFIDENCE"
	TokenScanResponseFeaturesFeatureIDImpersonatorMediumConfidence   TokenScanResponseFeaturesFeatureID = "IMPERSONATOR_MEDIUM_CONFIDENCE"
	TokenScanResponseFeaturesFeatureIDImpersonatorLowConfidence      TokenScanResponseFeaturesFeatureID = "IMPERSONATOR_LOW_CONFIDENCE"
	TokenScanResponseFeaturesFeatureIDImpersonationProtected         TokenScanResponseFeaturesFeatureID = "IMPERSONATION_PROTECTED"
	...
	TokenScanResponseFeaturesFeatureIDTransferFromReverts            TokenScanResponseFeaturesFeatureID = "TRANSFER_FROM_REVERTS"
	TokenScanResponseFeaturesFeatureIDOffensiveTokenMetadata         TokenScanResponseFeaturesFeatureID = "OFFENSIVE_TOKEN_METADATA"
	TokenScanResponseFeaturesFeatureIDListedOnCentralizedExchange    TokenScanResponseFeaturesFeatureID = "LISTED_ON_CENTRALIZED_EXCHANGE"
	TokenScanResponseFeaturesFeatureIDSanctionedCreator              TokenScanResponseFeaturesFeatureID = "SANCTIONED_CREATOR"
	TokenScanResponseFeaturesFeatureIDSpamText                       TokenScanResponseFeaturesFeatureID = "SPAM_TEXT"
	TokenScanResponseFeaturesFeatureIDBondingCurveToken              TokenScanResponseFeaturesFeatureID = "BONDING_CURVE_TOKEN"
	TokenScanResponseFeaturesFeatureIDHeavilySniped                  TokenScanResponseFeaturesFeatureID = "HEAVILY_SNIPED"
	TokenScanResponseFeaturesFeatureIDSolanaToken2022                TokenScanResponseFeaturesFeatureID = "SOLANA_TOKEN_2022"
	TokenScanResponseFeaturesFeatureIDPostDump                       TokenScanResponseFeaturesFeatureID = "POST_DUMP"
	TokenScanResponseFeaturesFeatureIDDexPaid                        TokenScanResponseFeaturesFeatureID = "DEX_PAID"
	TokenScanResponseFeaturesFeatureIDLowReputationCreator           TokenScanResponseFeaturesFeatureID = "LOW_REPUTATION_CREATOR"
	TokenScanResponseFeaturesFeatureIDSnipeAtMint                    TokenScanResponseFeaturesFeatureID = "SNIPE_AT_MINT"
	TokenScanResponseFeaturesFeatureIDTransferHookEnabled            TokenScanResponseFeaturesFeatureID = "TRANSFER_HOOK_ENABLED"
	TokenScanResponseFeaturesFeatureIDConfidentialTransfersEnabled   TokenScanResponseFeaturesFeatureID = "CONFIDENTIAL_TRANSFERS_ENABLED"
	TokenScanResponseFeaturesFeatureIDNonTranserable                 TokenScanResponseFeaturesFeatureID = "NON_TRANSERABLE"
	TokenScanResponseFeaturesFeatureIDTokenBackdoor                  TokenScanResponseFeaturesFeatureID = "TOKEN_BACKDOOR"
	TokenScanResponseFeaturesFeatureIDCreatedViaLaunchpad            TokenScanResponseFeaturesFeatureID = "CREATED_VIA_LAUNCHPAD"
	TokenScanResponseFeaturesFeatureIDCompromisedToken               TokenScanResponseFeaturesFeatureID = "COMPROMISED_TOKEN"
	TokenScanResponseFeaturesFeatureIDLongFundTrail                  TokenScanResponseFeaturesFeatureID = "LONG_FUND_TRAIL"
)

func (r TokenScanResponseFeaturesFeatureID) IsKnown() bool {
	switch r {
	case TokenScanResponseFeaturesFeatureIDVerifiedContract, TokenScanResponseFeaturesFeatureIDUnverifiedContract, TokenScanResponseFeaturesFeatureIDHighTradeVolume, TokenScanResponseFeaturesFeatureIDMarketPlaceSalesHistory, TokenScanResponseFeaturesFeatureIDHighReputationToken, TokenScanResponseFeaturesFeatureIDOnchainActivityValidator, TokenScanResponseFeaturesFeatureIDStaticCodeSignature, TokenScanResponseFeaturesFeatureIDKnownMalicious, TokenScanResponseFeaturesFeatureIDIsEoa, TokenScanResponseFeaturesFeatureIDIsContract, TokenScanResponseFeaturesFeatureIDErc20Contract, TokenScanResponseFeaturesFeatureIDTrustedContract, TokenScanResponseFeaturesFeatureIDBenignCreator, TokenScanResponseFeaturesFeatureIDMetadata, TokenScanResponseFeaturesFeatureIDAirdropPattern, TokenScanResponseFeaturesFeatureIDImpersonator, TokenScanResponseFeaturesFeatureIDInorganicVolume, TokenScanResponseFeaturesFeatureIDDynamicAnalysis, TokenScanResponseFeaturesFeatureIDConcentratedSupplyDistribution, TokenScanResponseFeaturesFeatureIDHoneypot, TokenScanResponseFeaturesFeatureIDInsufficientLockedLiquidity, TokenScanResponseFeaturesFeatureIDUnstableTokenPrice, TokenScanResponseFeaturesFeatureIDRugpull, TokenScanResponseFeaturesFeatureIDKnownRugpullCodePattern, TokenScanResponseFeaturesFeatureIDWashTrading, TokenScanResponseFeaturesFeatureIDConsumerOverride, TokenScanResponseFeaturesFeatureIDInappropriateContent, TokenScanResponseFeaturesFeatureIDHighTransferFee, TokenScanResponseFeaturesFeatureIDHighBuyFee, TokenScanResponseFeaturesFeatureIDHighSellFee, TokenScanResponseFeaturesFeatureIDUnsellableToken, TokenScanResponseFeaturesFeatureIDIsMintable, TokenScanResponseFeaturesFeatureIDModifiableTaxes, TokenScanResponseFeaturesFeatureIDCanBlacklist, TokenScanResponseFeaturesFeatureIDCanWhitelist, TokenScanResponseFeaturesFeatureIDHasTradingCooldown, TokenScanResponseFeaturesFeatureIDExternalFunctions, TokenScanResponseFeaturesFeatureIDHiddenOwner, TokenScanResponseFeaturesFeatureIDTransferPauseable, TokenScanResponseFeaturesFeatureIDOwnershipRenounced, TokenScanResponseFeaturesFeatureIDOwnerCanChangeBalance, TokenScanResponseFeaturesFeatureIDProxyContract, TokenScanResponseFeaturesFeatureIDSimilarMaliciousContract, TokenScanResponseFeaturesFeatureIDImpersonatorSensitiveAsset, TokenScanResponseFeaturesFeatureIDImpersonatorHighConfidence, TokenScanResponseFeaturesFeatureIDImpersonatorMediumConfidence, TokenScanResponseFeaturesFeatureIDImpersonatorLowConfidence, TokenScanResponseFeaturesFeatureIDImpersonationProtected, TokenScanResponseFeaturesFeatureIDFakeVolume, TokenScanResponseFeaturesFeatureIDHiddenSupplyByKeyHolder, TokenScanResponseFeaturesFeatureIDFakeTradeMakerCount, TokenScanResponseFeaturesFeatureIDTransferFromReverts, TokenScanResponseFeaturesFeatureIDOffensiveTokenMetadata, TokenScanResponseFeaturesFeatureIDListedOnCentralizedExchange, TokenScanResponseFeaturesFeatureIDSanctionedCreator, TokenScanResponseFeaturesFeatureIDSpamText, TokenScanResponseFeaturesFeatureIDBondingCurveToken, TokenScanResponseFeaturesFeatureIDHeavilySniped, TokenScanResponseFeaturesFeatureIDSolanaToken2022, TokenScanResponseFeaturesFeatureIDPostDump, TokenScanResponseFeaturesFeatureIDDexPaid, TokenScanResponseFeaturesFeatureIDLowReputationCreator, TokenScanResponseFeaturesFeatureIDSnipeAtMint, TokenScanResponseFeaturesFeatureIDTransferHookEnabled, TokenScanResponseFeaturesFeatureIDConfidentialTransfersEnabled, TokenScanResponseFeaturesFeatureIDNonTranserable, TokenScanResponseFeaturesFeatureIDTokenBackdoor, TokenScanResponseFeaturesFeatureIDCreatedViaLaunchpad, TokenScanResponseFeaturesFeatureIDCompromisedToken, TokenScanResponseFeaturesFeatureIDLongFundTrail:
		return true
	}
	return false
}
