...
func TestEvmTransactionScanWithOptionalParams(t *testing.T) {
	...
	_, err := client.Evm.Transaction.Scan(context.TODO(), blockaidclientgo.EvmTransactionScanParams{
		...
		Chain:          blockaidclientgo.F[blockaidclientgo.EvmTransactionScanParamsChainUnion](blockaidclientgo.TransactionScanSupportedChain(blockaidclientgo.TransactionScanSupportedChainEthereum)),
