...
// RequestOption is an option for the requests made by the blockaid API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/blockaid-official/blockaid-client-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("https://api.blockaid.io/v0/")
}
