...
func TestStarknetTransactionReportWithOptionalParams(t *testing.T) {
	...
	_, err := client.Starknet.Transaction.Report(context.TODO(), blockaidclientgo.StarknetTransactionReportParams{
		Details: blockaidclientgo.F("details"),
		Event:   blockaidclientgo.F(blockaidclientgo.StarknetTransactionReportParamsEventShouldBeMalicious),
		Report: blockaidclientgo.F[blockaidclientgo.StarknetTransactionReportParamsReportUnion](blockaidclientgo.StarknetTransactionReportParamsReportStarknetAppealRequestID{
			ID:   blockaidclientgo.F("id"),
			Type: blockaidclientgo.F(blockaidclientgo.StarknetTransactionReportParamsReportStarknetAppealRequestIDTypeRequestID),
		}),
	})
	if err != nil {
...
func TestStarknetTransactionScanWithOptionalParams(t *testing.T) {
	...
	_, err := client.Starknet.Transaction.Scan(context.TODO(), blockaidclientgo.StarknetTransactionScanParams{
		StarknetTransactionScanRequest: blockaidclientgo.StarknetTransactionScanRequestParam{
			AccountAddress: blockaidclientgo.F("0x62a2959fa6502b30cbfb51199fbbe72e72ee4f5a86ec754b4172c7d7beb6ff4"),
			Chain:          blockaidclientgo.F(blockaidclientgo.StarknetTransactionScanRequestChainMainnet),
			Metadata: blockaidclientgo.F[blockaidclientgo.StarknetTransactionScanRequestMetadataUnionParam](blockaidclientgo.StarknetTransactionScanRequestMetadataStarknetWalletRequestMetadataParam{
				Type: blockaidclientgo.F(blockaidclientgo.StarknetTransactionScanRequestMetadataStarknetWalletRequestMetadataTypeWallet),
				URL:  blockaidclientgo.F("giftnostra.com"),
			}),
			Transaction: blockaidclientgo.F[blockaidclientgo.StarknetTransactionScanRequestTransactionUnionParam](blockaidclientgo.StarknetTransactionScanRequestTransactionStarknetInvokeV3TransactionSchemaParam{
