...
func (r Erc1155Exposure) implementsTransactionSimulationAccountSummaryExposuresSpender() {}

func (r Erc1155Exposure) implementsTransactionSimulationExposuresSpender() {}
...
func (r Erc1155TokenDetails) implementsTransactionSimulationAccountSummaryExposuresAsset() {}

func (r Erc1155TokenDetails) implementsTransactionSimulationAssetsDiffsAsset() {}

func (r Erc1155TokenDetails) implementsTransactionSimulationExposuresAsset() {}
...
func (r Erc20Exposure) implementsTransactionSimulationAccountSummaryExposuresSpender() {}

func (r Erc20Exposure) implementsTransactionSimulationExposuresSpender() {}
...
func (r Erc20TokenDetails) implementsTransactionSimulationAccountSummaryExposuresAsset() {}

func (r Erc20TokenDetails) implementsTransactionSimulationAssetsDiffsAsset() {}

func (r Erc20TokenDetails) implementsTransactionSimulationExposuresAsset() {}
...
func (r Erc721Exposure) implementsTransactionSimulationAccountSummaryExposuresSpender() {}

func (r Erc721Exposure) implementsTransactionSimulationExposuresSpender() {}
...
func (r Erc721TokenDetails) implementsTransactionSimulationAccountSummaryExposuresAsset() {}

func (r Erc721TokenDetails) implementsTransactionSimulationAssetsDiffsAsset() {}

func (r Erc721TokenDetails) implementsTransactionSimulationExposuresAsset() {}
...
func (r NonercTokenDetails) implementsTransactionSimulationAccountSummaryExposuresAsset() {}

func (r NonercTokenDetails) implementsTransactionSimulationAssetsDiffsAsset() {}

func (r NonercTokenDetails) implementsTransactionSimulationExposuresAsset() {}
...
type TransactionSimulationAccountSummaryExposure struct {
	// description of the asset for the current diff
	Asset TransactionSimulationAccountSummaryExposuresAsset `json:"asset,required"`
	// dictionary of spender addresses where the exposure has changed during this
	// transaction for the current address and asset
	Spenders map[string]TransactionSimulationAccountSummaryExposuresSpender `json:"spenders,required"`
...
// description of the asset for the current diff
type TransactionSimulationAccountSummaryExposuresAsset struct {
	// address of the token
	Address string `json:"address,required"`
	// asset type.
	Type TransactionSimulationAccountSummaryExposuresAssetType `json:"type,required"`
	// asset's decimals
	Decimals int64 `json:"decimals"`
	// url of the token logo
	LogoURL string `json:"logo_url"`
	...
	// asset's symbol name
	Symbol string                                                `json:"symbol"`
	JSON   transactionSimulationAccountSummaryExposuresAssetJSON `json:"-"`
	union  TransactionSimulationAccountSummaryExposuresAssetUnion
}

// transactionSimulationAccountSummaryExposuresAssetJSON contains the JSON metadata
// for the struct [TransactionSimulationAccountSummaryExposuresAsset]
type transactionSimulationAccountSummaryExposuresAssetJSON struct {
	Address     apijson.Field
	Type        apijson.Field
	Decimals    apijson.Field
	LogoURL     apijson.Field
...
func (r transactionSimulationAccountSummaryExposuresAssetJSON) RawJSON() string {
	return r.raw
}

func (r *TransactionSimulationAccountSummaryExposuresAsset) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationAccountSummaryExposuresAsset{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationAccountSummaryExposuresAssetUnion]
// interface which you can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc20TokenDetails],
// [Erc1155TokenDetails], [Erc721TokenDetails], [NonercTokenDetails].
func (r TransactionSimulationAccountSummaryExposuresAsset) AsUnion() TransactionSimulationAccountSummaryExposuresAssetUnion {
	return r.union
}
...
type TransactionSimulationAccountSummaryExposuresAssetUnion interface {
	implementsTransactionSimulationAccountSummaryExposuresAsset()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*TransactionSimulationAccountSummaryExposuresAssetUnion)(nil)).Elem(),
		"",
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(Erc20TokenDetails{}),
...
const (
	...
	TransactionSimulationAccountSummaryExposuresAssetTypeNonerc  TransactionSimulationAccountSummaryExposuresAssetType = "NONERC"
)

func (r TransactionSimulationAccountSummaryExposuresAssetType) IsKnown() bool {
	switch r {
	case TransactionSimulationAccountSummaryExposuresAssetTypeErc20, TransactionSimulationAccountSummaryExposuresAssetTypeErc1155, TransactionSimulationAccountSummaryExposuresAssetTypeErc721, TransactionSimulationAccountSummaryExposuresAssetTypeNonerc:
		return true
	}
	return false
}

type TransactionSimulationAccountSummaryExposuresSpender struct {
	// the amount that was asked in the approval request for this spender from the
	// current address and asset
	...
	// user friendly description of the approval
	Summary string                                                  `json:"summary"`
	JSON    transactionSimulationAccountSummaryExposuresSpenderJSON `json:"-"`
	union   TransactionSimulationAccountSummaryExposuresSpendersUnion
}

// transactionSimulationAccountSummaryExposuresSpenderJSON contains the JSON
// metadata for the struct [TransactionSimulationAccountSummaryExposuresSpender]
type transactionSimulationAccountSummaryExposuresSpenderJSON struct {
	Approval         apijson.Field
	Expiration       apijson.Field
	Exposure         apijson.Field
	IsApprovedForAll apijson.Field
...
func (r transactionSimulationAccountSummaryExposuresSpenderJSON) RawJSON() string {
	return r.raw
}

func (r *TransactionSimulationAccountSummaryExposuresSpender) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationAccountSummaryExposuresSpender{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationAccountSummaryExposuresSpendersUnion]
// interface which you can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc20Exposure], [Erc721Exposure],
// [Erc1155Exposure].
func (r TransactionSimulationAccountSummaryExposuresSpender) AsUnion() TransactionSimulationAccountSummaryExposuresSpendersUnion {
	return r.union
}

// Union satisfied by [Erc20Exposure], [Erc721Exposure] or [Erc1155Exposure].
type TransactionSimulationAccountSummaryExposuresSpendersUnion interface {
	implementsTransactionSimulationAccountSummaryExposuresSpender()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*TransactionSimulationAccountSummaryExposuresSpendersUnion)(nil)).Elem(),
		"",
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
...
func (r *TransactionSimulationAssetsDiffsAsset) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationAssetsDiffsAsset{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationAssetsDiffsAssetUnion] interface which
// you can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc20TokenDetails],
// [Erc1155TokenDetails], [Erc721TokenDetails], [NonercTokenDetails],
...
func (r *TransactionSimulationAssetsDiffsIn) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationAssetsDiffsIn{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationAssetsDiffsInUnion] interface which you
// can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc1155Diff], [Erc721Diff],
// [Erc20Diff], [NativeDiff].
...
func (r *TransactionSimulationAssetsDiffsOut) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationAssetsDiffsOut{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationAssetsDiffsOutUnion] interface which you
// can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc1155Diff], [Erc721Diff],
// [Erc20Diff], [NativeDiff].
...
type TransactionSimulationExposure struct {
	// description of the asset for the current diff
	Asset TransactionSimulationExposuresAsset `json:"asset,required"`
	// dictionary of spender addresses where the exposure has changed during this
	// transaction for the current address and asset
	Spenders map[string]TransactionSimulationExposuresSpender `json:"spenders,required"`
...
// description of the asset for the current diff
type TransactionSimulationExposuresAsset struct {
	// address of the token
	Address string `json:"address,required"`
	// asset type.
	Type TransactionSimulationExposuresAssetType `json:"type,required"`
	// asset's decimals
	Decimals int64 `json:"decimals"`
	// url of the token logo
	LogoURL string `json:"logo_url"`
	...
	// asset's symbol name
	Symbol string                                  `json:"symbol"`
	JSON   transactionSimulationExposuresAssetJSON `json:"-"`
	union  TransactionSimulationExposuresAssetUnion
}

// transactionSimulationExposuresAssetJSON contains the JSON metadata for the
// struct [TransactionSimulationExposuresAsset]
type transactionSimulationExposuresAssetJSON struct {
	Address     apijson.Field
	Type        apijson.Field
	Decimals    apijson.Field
	LogoURL     apijson.Field
...
func (r transactionSimulationExposuresAssetJSON) RawJSON() string {
	return r.raw
}

func (r *TransactionSimulationExposuresAsset) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationExposuresAsset{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationExposuresAssetUnion] interface which you
// can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc20TokenDetails],
// [Erc1155TokenDetails], [Erc721TokenDetails], [NonercTokenDetails].
func (r TransactionSimulationExposuresAsset) AsUnion() TransactionSimulationExposuresAssetUnion {
	return r.union
}
...
// Union satisfied by [Erc20TokenDetails], [Erc1155TokenDetails],
// [Erc721TokenDetails] or [NonercTokenDetails].
type TransactionSimulationExposuresAssetUnion interface {
	implementsTransactionSimulationExposuresAsset()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*TransactionSimulationExposuresAssetUnion)(nil)).Elem(),
		"",
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(Erc20TokenDetails{}),
...
const (
	...
	TransactionSimulationExposuresAssetTypeNonerc  TransactionSimulationExposuresAssetType = "NONERC"
)

func (r TransactionSimulationExposuresAssetType) IsKnown() bool {
	switch r {
	case TransactionSimulationExposuresAssetTypeErc20, TransactionSimulationExposuresAssetTypeErc1155, TransactionSimulationExposuresAssetTypeErc721, TransactionSimulationExposuresAssetTypeNonerc:
		return true
	}
	return false
}

type TransactionSimulationExposuresSpender struct {
	// the amount that was asked in the approval request for this spender from the
	// current address and asset
	Approval string `json:"approval"`
	// the expiration time of the permit2 protocol
	...
	// user friendly description of the approval
	Summary string                                    `json:"summary"`
	JSON    transactionSimulationExposuresSpenderJSON `json:"-"`
	union   TransactionSimulationExposuresSpendersUnion
}

// transactionSimulationExposuresSpenderJSON contains the JSON metadata for the
// struct [TransactionSimulationExposuresSpender]
type transactionSimulationExposuresSpenderJSON struct {
	Approval         apijson.Field
	Expiration       apijson.Field
	Exposure         apijson.Field
	IsApprovedForAll apijson.Field
...
func (r transactionSimulationExposuresSpenderJSON) RawJSON() string {
	return r.raw
}

func (r *TransactionSimulationExposuresSpender) UnmarshalJSON(data []byte) (err error) {
	*r = TransactionSimulationExposuresSpender{}
	err = apijson.UnmarshalRoot(data, &r.union)
	if err != nil {
		return err
	}
...
// AsUnion returns a [TransactionSimulationExposuresSpendersUnion] interface which
// you can cast to the specific types for more type safety.
//
// Possible runtime types of the union are [Erc20Exposure], [Erc721Exposure],
// [Erc1155Exposure].
func (r TransactionSimulationExposuresSpender) AsUnion() TransactionSimulationExposuresSpendersUnion {
	return r.union
}

// Union satisfied by [Erc20Exposure], [Erc721Exposure] or [Erc1155Exposure].
type TransactionSimulationExposuresSpendersUnion interface {
	implementsTransactionSimulationExposuresSpender()
}

func init() {
	apijson.RegisterUnion(
		reflect.TypeOf((*TransactionSimulationExposuresSpendersUnion)(nil)).Elem(),
		"",
		apijson.UnionVariant{
			TypeFilter: gjson.JSON,
			Type:       reflect.TypeOf(Erc20Exposure{}),
